...
?>
		...
		<div id="layout-switcher">
			...
			<div class="container">
				<div id="custom-location">
					...
					<input type="button" id="set-custom" data-waypoint="" value="Set" />
				</div>
	...
	<script type="text/js-templte" id="tmpl-ticket">
		<ul id="flipper">
			<li id="change-from" class="station" data-waypoint="from" data-label="Starting point">
			...
			<li id="change-dest" class="station" data-waypoint="to" data-label="Destination">
